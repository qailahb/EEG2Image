...
# Defines number of filters and strides for each Conv2DTranspose block
		...
		# For discrete condition we are using Embedding (if using class labels)
		...
		# Generator convoluton blocks
		# builds a list of spectral-normalised layers
